const API_URL = (window.location.hostname === "127.0.0.1" || window.location.hostname === "localhost") && window.location.port !== "8000" && window.location.port !== "" 
  ? "https://chargeops-ai.onrender.com/api" 
  : "/api";
